...
def build_signal(lower_tf: list[Candle], higher_tf: list[Candle], risk_reward: float, min_signal_score: int) -> SignalSetup | None:
    ...
    if bias == "bullish":
        ...
        return SignalSetup(
            ...
            reason="Bullish higher-timeframe bias + break of structure + pullback into value zone + bullish candle confirmation.",
    ...
    return SignalSetup(
        ...
        stop_loss=stop_loss,
        take_profit=take_profit,
        reason="Bearish higher-timeframe bias + break of structure + pullback into value zone + bearish candle confirmation.",
        risk_reward=risk_reward,
